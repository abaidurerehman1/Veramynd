...
├── frontend/                   # React UI (Overview → Exports, Ingestion, Pipeline, Logging)
├── backend/                    # FastAPI API + ingest + pipeline jobs + projects.json
...
**Operator UI:** run API (`backend/`, port **8000**) + UI (`frontend/`, port **5173**).
Upload PDF+XLSX, run Complete auto or step-by-step, resume after interruption from saved
output. Details: [`backend/README.md`](backend/README.md), [`frontend/README.md`](frontend/README.md).
...
| [backend/README.md](backend/README.md) | FastAPI API, ingest, pipeline jobs, resume, project registry |
| [frontend/README.md](frontend/README.md) | React UI pages (run at :5173; API default :8000) |
